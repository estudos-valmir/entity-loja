...
namespace entity_loja.Migrations
{
    ...
    [Migration("20220710003154_promocao_update")]
    partial class promocao_update
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("entity_loja.Repo.Entities.Promocao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProdutoPromocao", b =>
                {
                    b.HasOne("entity_loja.Repo.Entities.Produto", null)
                        .WithMany()
                        .HasForeignKey("ProdutosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("entity_loja.Repo.Entities.Promocao", null)
                        .WithMany()
